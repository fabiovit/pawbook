      ...
      <div class="page">
        <div class="topbar">
          <div class="brand">
            ...
            <div><h1>PawBook <span class="v2-badge">4.7.0</span></h1><div class="muted">Libretto sanitario digitale</div></div>
          </div>
        </div>
...
if (!customElements.get("pawbook-panel-v470")) {
  customElements.define("pawbook-panel-v470", PawBookPanelV420);
}
