class PawBookPanelV201 extends HTMLElement {
  constructor() {
    super();
    ...
    const styles = `
      ...
      * { box-sizing: border-box; }
      ...
      @media(max-width:600px) {
        ...
        .pedigree-section { margin-left:-16px; margin-right:-16px; padding-left:0; padding-right:0; overflow:hidden; }
        .pedigree-section > .card-head,.pedigree-section > .enci-panels,.pedigree-section > .enci-note { margin-left:16px; margin-right:16px; }
        .pedigree-wrap {
          width:100%; overflow-x:auto; overflow-y:hidden; padding:6px 16px 18px;
          scroll-snap-type:x proximity; scrollbar-width:thin; -webkit-overflow-scrolling:touch;
          overscroll-behavior-x:contain;
        }
        .pedigree-root { width:300px; margin:0 0 16px 105px; padding:12px; gap:10px; }
        .pedigree-root-photo { width:58px; height:58px; border-radius:13px; }
        .pedigree-row { grid-template-columns:90px max-content; gap:10px; }
        .generation-label { width:90px; padding:8px 5px; font-size:11px; }
        .pedigree-person { min-width:150px; max-width:150px; min-height:92px; padding:9px; }
        .pedigree-person.generation-4 { min-width:132px; max-width:132px; font-size:10px; }
        .pedigree-fourth-groups { gap:8px; }
        .pedigree-family-group { gap:6px; padding:6px; }
...
if (!customElements.get("pawbook-panel-v201")) {
  customElements.define("pawbook-panel-v201", PawBookPanelV201);
}
