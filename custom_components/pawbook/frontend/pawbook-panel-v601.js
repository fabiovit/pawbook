class PawBookPanelV420 extends HTMLElement {
  ...
  render() {
    ...
    this.shadowRoot.innerHTML = `
      ...
      <div class="page">
        <div class="topbar">
          <button type="button" class="ha-mobile-menu" id="ha-mobile-menu" aria-label="Apri menu Home Assistant" title="Apri menu Home Assistant">
    ...
    this.shadowRoot.querySelector("#ha-mobile-menu")?.addEventListener("click", (event) => {
      ...
      event.currentTarget.dispatchEvent(new Event("hass-toggle-menu", {
        bubbles: true,
        composed: true,
      }));
    });
...
if (!customElements.get("pawbook-panel-v601")) {
  customElements.define("pawbook-panel-v601", PawBookPanelV420);
}
