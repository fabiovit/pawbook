      ...
      <div class="page">
        <div class="topbar">
          <div class="brand">
            ...
            <div><h1>PawBook <span class="v2-badge">5.0.0</span></h1><div class="muted">Libretto sanitario digitale</div></div>
          </div>
        </div>
...
if (!customElements.get("pawbook-panel-v500")) {
  customElements.define("pawbook-panel-v500", PawBookPanelV420);
}
