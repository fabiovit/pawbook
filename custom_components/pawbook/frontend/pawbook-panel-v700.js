/* PawBook v7.0.0 clean major release */
/* PawBook HA theme-aware frontend v7.0.0 */
/* PawBook cache-bust asset: v7.0.0 */
class PawBookPanelV420 extends HTMLElement {
  ...
  render() {
    ...
    this.shadowRoot.innerHTML = `
      ...
      /* PawBook 7.0.0 definitive mobile header */
      .topbar{
      ...
      /* PawBook 7.0.0 · DOMOTICA / Inverter shell */
      :host{
      ...
      /* PawBook 7.0.0 — true structural redesign */
      .page{
...
/* PawBook 7.0.0 Recovery UI Polish */
:host {
  --pb-radius-lg: 24px;
  --pb-radius-md: 16px;
...
/* PawBook 7.0.0 DOMOTICA Rebuild */
:host {
  --pb-gap: 18px;
  --pb-radius-xl: 28px;
  --pb-radius-lg: 20px;
...
/* PawBook 7.0.0 DOMOTICA shell + Agenda */
.pb-domotica-header{
  position:sticky!important;
  top:10px!important;
...
/* PawBook 7.0.0 Health OS stable rebuild */
.pb-os-header{
...
/* PawBook 7.0.0 - Modern Health Center */
:host{
  --pb-accent:#58d6c7;
  --pb-accent-2:#76e2d5;
...
/* PawBook 7.0.0 - clearer menu + unified management */
.pb-clear-nav{
  display:flex!important;
  align-items:center!important;
  gap:25px!important;
...
/* PawBook 7.0.0 - visual refinement */
...
/* PawBook 7.0.0 — Health Control Center */
:host{
  --pb-accent:#55d8c8;
  --pb-accent2:#65bdf4;
  --pb-surface:#181a1a;
...
/* PawBook 7.0.0 — management intro visibility fix */
#management-intro{
  display:none!important;
}
...
/* PawBook 7.0.0 — typography readability */
.pb-clear-nav>button{
  font-size:13px!important;
}
...
/* PawBook 7.0.0 — BIG typography pass */
...
/* PawBook 7.0.0 — light theme fix only */
...
/* PawBook 7.0.0 — dark theme restoration */
...
/* PawBook 7.0.0 — Home Assistant theme-aware override */
            ...
            <div class="pb-modern-brandleft">
              ...
              <div class="pb-modern-brandcopy">
                <div class="pb-modern-titleline">
                  ...
                  <span class="pb-modern-version">7.0.0</span>
                </div>
