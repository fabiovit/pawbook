  ...
  render() {
    ...
    const styles = `
      ...
      * { box-sizing: border-box; }
      ...
      .generation-count-16 { grid-template-columns:repeat(16, 112px); width:max-content; }
      ...
      .pedigree-person.generation-4 { min-height:150px; padding:10px 9px; }
      .pedigree-person.generation-4 strong { font-size:12px; line-height:1.22; }
      .pedigree-person.generation-4 span,.pedigree-person.generation-4 small,.pedigree-person.generation-4 .person-relation { font-size:10px; }
