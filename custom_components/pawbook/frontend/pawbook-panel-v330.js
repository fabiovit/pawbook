class PawBookPanelV330 extends HTMLElement {
  constructor() {
    super();
      ...
      <div class="page">
        <div class="topbar">
          <div class="brand">
            ...
            <div><h1>PawBook <span class="v2-badge">3.3</span></h1><div class="muted">Libretto sanitario digitale</div></div>
          </div>
        </div>
...
if (!customElements.get("pawbook-panel-v330")) {
  customElements.define("pawbook-panel-v330", PawBookPanelV330);
}
