class PawBookPanelV121 extends HTMLElement {
  constructor() {
    super();
  ...
  render() {
    ...
    const styles = `
      ...
      * { box-sizing: border-box; }
      ...
      .brand-mark svg { width:34px; height:34px; display:block; fill:var(--primary-color); }
...
if (!customElements.get("pawbook-panel-v120")) {
  customElements.define("pawbook-panel-v121", PawBookPanelV121);
}
