      ...
      <div class="page">
        <div class="topbar">
          <div class="brand">
            ...
            <div><h1>PawBook <span class="v2-badge">4.4</span></h1><div class="muted">Libretto sanitario digitale</div></div>
          </div>
        </div>
        ...
        <section class="grid">
          ...
          <article class="card heat-center">
            <div class="card-head">
              <div>
...
if (!customElements.get("pawbook-panel-v460")) {
  customElements.define("pawbook-panel-v460", PawBookPanelV420);
}
