class PawBookPanelV112 extends HTMLElement {
  constructor() {
    super();
    ...
    dialog.innerHTML = `
      <div class="modal">
        <div class="modal-card ancestor-modal">
          ...
          <section class="ancestor-extra"><h3>Dati sanitari</h3>${list(node.health)}</section>
  ...
  render() {
    ...
    const styles = `
      ...
      * { box-sizing: border-box; }
      ...
      .photo-button { position:relative; padding:0; border:0; background:transparent; border-radius:24px; }
      ...
      .photo-button .placeholder { width:112px; height:112px; border-radius:24px; background:var(--secondary-background-color); }
      ...
      .pedigree-person.generation-4 { min-height:132px; padding:8px 7px; }
      .pedigree-person.generation-4 strong { font-size:10px; line-height:1.15; margin-top:3px; }
      .pedigree-person.generation-4 span,.pedigree-person.generation-4 small,.pedigree-person.generation-4 .person-relation { font-size:8.5px; line-height:1.15; }
...
if (!customElements.get("pawbook-panel-v112")) {
  customElements.define("pawbook-panel-v112", PawBookPanelV112);
}
