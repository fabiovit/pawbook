class PawBookPanelV420 extends HTMLElement {
  ...
  render() {
    ...
    this.shadowRoot.innerHTML = `
      ...
      /* PawBook 6.2.0 definitive mobile header */
      .topbar{
      ...
      /* PawBook 6.2.0 · DOMOTICA / Inverter shell */
      :host{
      ...
      <div class="page">
            ...
            <div class="top-left">
              ...
              <div class="brand-copy">
                <div class="brand-title-row">
                  ...
                  <span class="version-badge v2-badge">6.2.0</span>
                </div>
        ...
        <section class="stats telemetry-rail">
...
if (!customElements.get("pawbook-panel-v620")) {
  customElements.define("pawbook-panel-v620", PawBookPanelV420);
}
